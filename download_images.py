...
# python3 download_images.py --output /media/hdddati1/omran/Geo_data_models/resources/dataset/test_dir
#  --url_csv /media/hdddati1/omran/Geo_data_models/resources/dataset/urls/test.csv --shuffle
...
def parse_args():
    ...
    args.add_argument(
        ...
        type=Path,
        #default=Path(
        #    "/data2/omran/dataset/flickr_splash_mapilry/valid_dir"),
    ...
    args.add_argument(
        ...
        # train_urls
        #default=Path(
        #    "/data2/omran/dataset/urls/valid.csv"),
    )
    args.add_argument(
        "--size",
        type=int,
