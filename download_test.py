...
def download_mapillary(x, min_edge_size, access_token):
    ...
    image.save(
        '/data2/omran/dataset_3.8/test_images/flickr_splash_mapillry_test_images/{}.jpeg'.format(image_id))
...
def parse_args():
    ...
    args.add_argument(
        ...
        type=Path,
        #default=Path(
        #    "/data2/omran/dataset_3.8/flickr_splash_mapilry/test_dir"),
    ...
    args.add_argument(
        ...
        # train_urls
        #default=Path(
        #    "/data2/omran/dataset_3.8/urls/test.csv"),
    )
    args.add_argument(
        "--size",
        type=int,
